...
```bash
curl http://localhost:8076/api/proyecto        # total: 8
curl -i http://localhost:8076/api/proyecto/PR999   # → 404
```
...
- [ ] Modelos/Proyecto.cs (la entidad: 4 propiedades tipadas)
- [ ] Peticiones/ProyectoCrear.cs (todo obligatorio, con [Required])
